...
**Версии:** `/adv/v1/`, `/adv/v3/`. `/adv/v0/` частично жива: `pause`, `start`, `normquery/*` — боевые (200, см. разделы ниже), остальные v0-методы мёртвые (404). `/adv/v2/` — для `save-ad` (`supplier/nms`); `fullstats` живёт на `/adv/v3/`, а не на v2.
